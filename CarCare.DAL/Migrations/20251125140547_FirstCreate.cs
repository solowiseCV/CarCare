        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MechanicProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DefaultAddress = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportLicenseNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    VerificationDocumentsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallationRequested = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarMake = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    IsAuthentic = table.Column<bool>(type: "bit", nullable: false),
                    AuthenticityCertificateUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MechanicProfileId",
                table: "AspNetUsers",
                column: "MechanicProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SupplierProfileId",
                table: "AspNetUsers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Customers_CustomerProfileId",
                table: "AspNetUsers",
                column: "CustomerProfileId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Mechanics_MechanicProfileId",
                table: "AspNetUsers",
                column: "MechanicProfileId",
                principalTable: "Mechanics",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Suppliers_SupplierProfileId",
                table: "AspNetUsers",
                column: "SupplierProfileId",
                principalTable: "Suppliers",
                principalColumn: "Id");
